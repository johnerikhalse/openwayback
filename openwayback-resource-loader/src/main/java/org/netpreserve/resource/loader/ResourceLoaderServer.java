...
import org.netpreserve.resource.loader.settings.ServerSettings;
import org.netpreserve.resource.loader.settings.Settings;
import org.netpreserve.resource.loader.settings.SettingsUtil;
 ...
 */
public class ResourceLoaderServer {

    private static final Logger LOG = LoggerFactory.getLogger(ResourceLoaderServer.class);

    /**
     * Construct a new ResourceResolverServer and start it.
     */
    public ResourceLoaderServer() {
        ...
        ResourceStore cdxSource = SettingsUtil.createResourceStore(settings.getResourceStore());
        ...
        LOG.info("Resource Loader (v. {}) started",
                ResourceLoaderServer.class.getPackage().getImplementationVersion());
    }
