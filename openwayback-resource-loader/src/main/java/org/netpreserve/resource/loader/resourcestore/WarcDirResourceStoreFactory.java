 ...
 *
 */
public class WarcDirResourceStoreFactory extends ResourceStoreFactory {
    @Override
    ...
    @Override
    protected ResourceStore createCdxSource(Uri identifier) {
        return new JwatLocalFileResourceStore(identifier.getPath());
    }
