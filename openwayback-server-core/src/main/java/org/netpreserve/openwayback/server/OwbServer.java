...
import org.netpreserve.openwayback.server.settings.ServerSettings;
 ...
 */
public abstract class OwbServer {

    private static final Logger LOG = LoggerFactory.getLogger(OwbServer.class);
    ...
    public OwbServer() {
        ...
        try {
            ...
            settings = ConfigBeanFactory.create(config, getSettingsClass());
        ...
        ResourceConfig config = ResourceConfig.forApplication(createApplicationConfig(settings));
        ...
        LOG.info(getServerName() + " (v. {}) started",
                this.getClass().getPackage().getImplementationVersion());
    }

    public abstract Class<? extends Settings> getSettingsClass();

    public abstract BaseApplicationConfig createApplicationConfig(Settings settings);
